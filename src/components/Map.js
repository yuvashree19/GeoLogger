...
export default function Map(){
    ...
    const {isLoading:isLoadingPosition,position:geolocationPosition,getGeoLocation}=useGeolocation();
 ...
 useEffect(
    ...
    return <div className={styles.mapContainer}>
     <Button type="position" onClick={getGeoLocation}>{isLoadingPosition ? "Loading..." : "Use Your Position"}</Button>
